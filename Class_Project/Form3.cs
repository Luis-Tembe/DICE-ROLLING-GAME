...
namespace Class_Project
{
    public partial class Form3 : Form
    {
        ...
        private void btnRollDice_Click(object sender, EventArgs e)
        {
            ...
            GetResult();
            DisplayResult();
            // Declare a random data to get random values from the dice roll
            /* Random rand = new Random();
             dice = rand.Next(1, 7);
             switch (dice)
             {
                 case 1:picBoxChangeDice.Load("Dice\\dice1.png"); break;
                 case 2: picBoxChangeDice.Load("Dice\\dice2.png"); break;
                 case 3: picBoxChangeDice.Load("Dice\\dice3.png"); break;
                 case 4: picBoxChangeDice.Load("Dice\\dice4.png"); break;
                 case 5: picBoxChangeDice.Load("Dice\\dice5.png"); break;
                 case 6: picBoxChangeDice.Load("Dice\\dice6.png"); break;
                 default: break;
             }*/
